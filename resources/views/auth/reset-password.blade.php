...
<head>
    <meta charset="utf-8" />
    <title>Reset Password - KelyxGlobal Multivendors eCommerce Soltions</title>
                                    ...
                                    <form method="POST" action="{{ route('password.store') }}">
                                        @csrf
                                            <div class="form-group">
                                                <input type="email" id="email" required="" name="email" placeholder="{{ old('email', $request->email) }} *" />
                                            </div>
                                            <div class="form-group">
                                                <input type="password" id="password" required="" name="password" placeholder="Password *" />
                                            </div>
                                            <div class="form-group">
                                                <input type="password" id="password_confirmation" required="" name="password_confirmation" placeholder="Confirm you password *" />
                                            </div>
                                            <div class="form-group">
