									...
									<form method="post" action="{{ route('vendor.profile.store') }}" enctype="multipart/form-data">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <select name="vendor_join" class="form-select mb-3" aria-label="Default select example">
                                                ...
                                                <option value="2023" {{ $vendorData->vendor_join == 2024 ? 'selected' : '' }} >2024</option>
                                                <option value="2023" {{ $vendorData->vendor_join == 2025 ? 'selected' : '' }} >2025</option>
                                                <option value="2023" {{ $vendorData->vendor_join == 2026 ? 'selected' : '' }} >2026</option>
                                                <option value="2023" {{ $vendorData->vendor_join == 2027 ? 'selected' : '' }} >2027</option>
                                            </select>
											</div>
										</div>
