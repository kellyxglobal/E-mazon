...
<div class="col-lg-10">
 ...
 <form id="myForm" method="post" action="{{ route('update.country') }}"   >
	 	...
	 	<select name="division_id" class="form-select mb-3" aria-label="Default select example">
		 	...
		 	<option value="{{ $item->id }}" {{ $item->id == $country->division_id ? 'selected' : ''  }}>{{ $item->division_name }}</option>
		 	@endforeach
...
<div class="row mb-3">
	 	...
	 	<select name="district_id" class="form-select mb-3" aria-label="Default select example">
		 	...
		 	<option value="{{ $item->id }}" {{ $item->id == $country->district_id ? 'selected' : ''  }}>{{ $item->district_name }}</option>
		 	@endforeach
...
<div class="row mb-3">
	 	...
	 	<select name="state_id" class="form-select mb-3" aria-label="Default select example">
		 	...
		 	<option value="{{ $item->id }}" {{ $item->id == $country->state_id ? 'selected' : ''  }}>{{ $item->state_name }}</option>
		 	@endforeach
