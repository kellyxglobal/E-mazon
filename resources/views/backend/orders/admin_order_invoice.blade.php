  ...
  <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        <td valign="top">
          ...
          <h2 style="color: green; font-size: 26px;"><strong>KellyxGlobal Online Shopping Cart</strong></h2>
        </td>
        <td align="right">
            <pre class="font" >
               EasyShop Head Office
               Email:support@kellyxglobal.com <br>
               Mob: 09037541494 <br>
               No. 10 Adesiji, Badoore Lagos:#4 <br>
        ...
        <td>
          <p class="font" style="margin-left: 20px;">
           ...
           <strong>Phone:</strong> {{ $order->phone }} <br>
            ...
            $country = $order->state->country_name; 
            @endphp
           <strong>Address:</strong> {{ $order->adress }} / {{$div}} / {{ $dis }}/ {{ $state }}/ {{ $country }}<br>
