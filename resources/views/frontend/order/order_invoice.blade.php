...
<body>
  ...
  <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        ...
        <td align="right">
            <pre class="font" >
               Kellyxglobal Head Office
               Email:support@kellyxglobalOnlineShopping.com <br>
               Mob: 1245454545 <br>
               Lagos 1207,Lekki Phase:#1 <br>
        ...
        <td>
          ...
          <strong>Name:</strong> {{ $order->name }} <br>
           ...
           <strong>Phone:</strong> {{ $order->phone }} <br>
            ...
            @endphp
           <strong>Address:</strong> {{ $order->address }} / {{$div}} / {{ $dis }}/ {{ $state }}/ {{ $country }}<br>
