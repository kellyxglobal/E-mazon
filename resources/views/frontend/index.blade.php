...
<section class="product-tabs section-padding position-relative">
            <div class="container">
                ...
                <h3>{{ $skip_category_8->category_name }} Category </h3>
...
<!-- home Vendors List starts -->
@include('frontend.home.home_vendor_list')
<!-- home Vendors List ends -->
